...
void db_init(void)
{
    ...
    if(ret != SQLITE_OK)
    {
        ...
        sqlite3_finalize(stmt_append_request);
        should_terminate = true;
    }
...
void db_append_request(uint8_t *request_buffer)
{
    ...
    sqlite3_bind_int(stmt_append_request, 3, request_buffer[TEST_PACKET_ITERATIONS_BYTE_OFFSET]);
    sqlite3_bind_int(stmt_append_request, 4, request_buffer[TEST_PACKET_SELECTION_BYTE_OFFSET]);
    sqlite3_bind_text(stmt_append_request, 5, (char *)request_buffer+TEST_PACKET_STRING_HEAD_OFFSET, request_buffer[TEST_PACKET_STRING_LEN_OFFSET], SQLITE_TRANSIENT);
...
void db_append_results(uint8_t *results_buffer, uint8_t *request_buffer, float duration_secs)
{
    ...
    sqlite3_bind_double(stmt_append_result, 3, duration_secs);
    ...
    sqlite3_bind_text(stmt_append_result, 7, (char *)request_buffer+TEST_PACKET_STRING_HEAD_OFFSET, request_buffer[TEST_PACKET_STRING_LEN_OFFSET], SQLITE_TRANSIENT);
